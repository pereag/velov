...
function init(){
    ...
    let map = new Maps(document.getElementById("api--google"), 45.75, 4.85, 15, document.getElementById("station-name"), document.getElementById("station-address"), document.getElementById("station-status"), document.getElementById("velov-number"))
    map.play()
